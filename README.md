...
Feedstock license: [BSD-3-Clause](https://github.com/hep-forge/root-feedstock/blob/main/LICENSE.txt)
...
Note that all branches in the hep-forge/root-feedstock are
